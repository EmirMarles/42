...
/*   Updated: 2025/02/22 16:50:38 by emarles          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int    display()
{
    ...
    if (main.mlx_connection == NULL)
        return(1);
    main.mlx_win = mlx_new_window(main.mlx_connection, HEIGHT, WIDTH, "this is running");
    ...
    main.img.img_ptr = mlx_new_image(main.mlx_connection, HEIGHT, WIDTH); //creating an image
